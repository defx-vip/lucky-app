<template>
	<div class="recharge">
		<div class="cashout">
			...
			<input type="text" :placeholder="$t('lEnteramount')" v-model="money" @keydown="handleInput" @focus="scoll" @click="scoll" />
		...
		methods: {
			...
			recharge() {
				...
				this.$post(this.$apiUtil.getRechargeAddress, {
					...
					web3tools.transfer(res.data.tokenContract,res.data.tokenCode,_this.money,res.data.tokenAddress,(e) => {_this.$router.back(-1)});
				})
			},
		},
	}
